...
<script runat="server">
    ...
    public override bool CheckAuthentication()
    {
        ...
        //Phải bật lên khi check quyền đăng nhập
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = "tuyennguyen";
        LicenseKey = "R5Y8LVYJMFP8LVYJ37SP9EESCQP3EN5F";
        ...
        // feature.
        Images.MaxWidth = 6988;// 1600;
        Images.MaxHeight = 4941;// 1200;
        Images.Quality = 80;
